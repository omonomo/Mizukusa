...
実際に使用する状況に近づけるため、句読点や括弧の後にスペースキーでかな漢字変換を行うことを想定しています。
...
- [1文字単位の出現数](./data/list_1mozi.csv)
- [1音単位の出現数](./data/list_1on.csv)
- [連続した2文字の出現数](./data/list_2mozi_renzoku.csv)
- [連続した2音の出現数](./data/list_2on_renzoku.csv)
- [1文字挟んだ2文字の出現数](./data/list_2mozi_1tutobasi.csv)
...
## おまけ 新ローマ字配列
配列を考える過程で、ローマ字入力も検討していた時に作ったものです。あくまでも思いつきなので、不具合がないかしっかりと試してはいません。ヘボン式と共存できるようにしたつもりです。  
